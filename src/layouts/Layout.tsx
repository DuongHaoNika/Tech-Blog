  ...
  return (
    <div className={`min-h-screen flex flex-col transition-colors duration-200 ${isDark ? 'dark bg-gray-900' : 'bg-gray-50'}`}>
      <div className="flex-grow">
        <Head>
          <title>{title} - HaoDQ&apos;s Blog</title>
          ...
          <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16 items-center">
              ...
              <div className="flex items-center space-x-6">
                ...
                <Link href="https://github.com/DuongHaoNika/Tech-Blog" className="nav-link">Github</Link>
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-3">
              <h3 className="text-xl font-bold mb-3 dark:text-white">About HaoDQ&apos;s Blog</h3>
            ...
            <div>
              ...
              <div className="flex space-x-4 dark:text-gray-100">
                <a href="https://github.com/DuongHaoNika" target="_blank" rel="noopener noreferrer" className="social-link">
                ...
                <a href="https://x.com/haoloha_04" target="_blank" rel="noopener noreferrer" className="social-link">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
